  ...
  function SwipeableViews() {
    ...
    return _ret = (_temp = (_this = (0, _possibleConstructorReturn3.default)(this, (_ref = SwipeableViews.__proto__ || (0, _getPrototypeOf2.default)(SwipeableViews)).call.apply(_ref, [this].concat(args))), _this), _this.state = {}, _this.rootNode = null, _this.containerNode = null, _this.ignoreNextScrollEvents = false, _this.viewLength = 0, _this.startX = 0, _this.lastX = 0, _this.vx = 0, _this.startY = 0, _this.isSwiping = undefined, _this.started = false, _this.startIndex = 0, _this.transitionListener = null, _this.touchMoveListener = null, _this.activeSlide = null, _this.indexCurrent = null, _this.handleSwipeStart = function (event) {
      ...
      if (transform && transform !== 'none') {
        ...
        if (typeof _this.props.onSwipeStart !== 'undefined') {
          _this.props.onSwipeStart(_this.startIndex);
        }
      }
      ...
      if (typeof _this.props.onSwipeMove !== 'undefined') {
        _this.props.onSwipeMove(index);
      }
