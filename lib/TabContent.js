...
var TabContent = function (_React$Component) {
  ...
  (0, _createClass3.default)(TabContent, [{
    ...
    key: 'clampHeight',
    value: function clampHeight(toClamp) {
      var _this2 = this;
      ...
      if (this._ref && this.isHeightClamped !== toClamp) {
        requestAnimationFrame(function () {
          ...
          _this2.isHeightClamped = toClamp;
        });
      }
    }
  }, {
    ...
    value: function componentWillReceiveProps(nextProps) {
      ...
      if (nextProps.shouldLoad !== this.props.shouldLoad) {
        if (this.loadCallback) {
          (0, _domUtils.cancelIdleCallback)(this.loadCallback);
        }
        this.loadCallback = (0, _domUtils.requestIdleCallback)(function () {
          if (_this3.props.isShown) {
            _this3.setState({ show: nextProps.shouldLoad });
            _this3.loadCallback = null;
          } else {
            _this3.loadCallback = (0, _domUtils.requestIdleCallback)(function () {
              _this3.setState({ show: nextProps.shouldLoad });
              _this3.loadCallback = null;
            });
          }
