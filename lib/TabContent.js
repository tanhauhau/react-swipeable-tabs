...
var TabContent = function (_React$Component) {
  ...
  function TabContent() {
    ...
    return _ret = (_temp = (_this = (0, _possibleConstructorReturn3.default)(this, (_ref = TabContent.__proto__ || (0, _getPrototypeOf2.default)(TabContent)).call.apply(_ref, [this].concat(args))), _this), _this.state = { show: false }, _this._ref = null, _this.maxHeight = WINDOW_HEIGHT, _temp), (0, _possibleConstructorReturn3.default)(_this, _ret);
  }
  ...
  (0, _createClass3.default)(TabContent, [{
    ...
    value: function render() {
      ...
      var style = this.props.isShown ? null : { maxHeight: this.maxHeight, overflowY: 'hidden' };
      return _react2.default.createElement(
        'div',
        { ref: function ref(_ref3) {
            return _this3._ref = _ref3;
          }, style: style },
