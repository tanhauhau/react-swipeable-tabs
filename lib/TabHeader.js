...
var TabHeader = function (_React$Component) {
  ...
  (0, _createClass3.default)(TabHeader, [{
    ...
    value: function shouldComponentUpdate(nextProps) {
      process.env.NODE_ENV !== "production" ? (0, _warning2.default)(nextProps.TabComponent === this.props.TabComponent, 'react-swipeable-tabs: will not rerender tab header when `TabComponent` change') : void 0;
      process.env.NODE_ENV !== "production" ? (0, _warning2.default)(nextProps.tabBackground === this.props.tabBackground, 'react-swipeable-tabs: will not rerender tab header when `tabBackground` change') : void 0;
      process.env.NODE_ENV !== "production" ? (0, _warning2.default)(nextProps.tabHeight === this.props.tabHeight, 'react-swipeable-tabs: will not rerender tab header when `tabHeight` change') : void 0;
      process.env.NODE_ENV !== "production" ? (0, _warning2.default)(nextProps.tabIndicatorComponent === this.props.tabIndicatorComponent, 'react-swipeable-tabs: will not rerender tab header when `tabIndicatorComponent` change') : void 0;
      process.env.NODE_ENV !== "production" ? (0, _warning2.default)(nextProps.tabIndicatorStyle === this.props.tabIndicatorStyle, 'react-swipeable-tabs: will not rerender tab header when `tabIndicatorStyle` change') : void 0;
      process.env.NODE_ENV !== "production" ? (0, _warning2.default)(nextProps.onChangeIndex === this.props.onChangeIndex, 'react-swipeable-tabs: will not rerender tab header when `onChangeIndex` change') : void 0;
